...
/**
 * Created by Shen Chang-Shao on 2016/3/11.
 */
public class VigenereAcitvity extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SampleFragmentPagerAdapter pagerAdapter = new SampleFragmentPagerAdapter(getSupportFragmentManager(), VigenereAcitvity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about_cipher) {
            AboutVigenere dialog = new AboutVigenere();
    ...
    int[] keys = {R.id.key_edit_encrypt, R.id.key_edit_decrypt, R.id.key_edit_encrypt_file, R.id.key_edit_decrypt_file};
    ...
    public void showEncrypt(View view) {
        ...
        TextView keyView = (TextView) findViewById(keys[pos]);
        if (isValidKey(key)) {
            VigenereCipher vc = new VigenereCipher(key);
            String encrypted = vc.encrypt(text);
            result.setText(encrypted);
            if (pos > 1 && !result.getText().toString().equals("")) {
            ...
            callToast("Please enter a word as key");
            result.setText("");
            keyView.setText("");
        }
    ...
    public void showDecrypt(View view) {
        ...
        if (isValidKey(key)) {
            ...
            String decrypted = vb.decrypt(text);
            decrypt.setText(decrypted);
            if (pos > 1 && !decrypt.getText().toString().equals("")) {
                Button saver = (Button) findViewById(saveButtons[pos - 2]);
                saver.setVisibility(View.VISIBLE);
                Button sender = (Button) findViewById(sendButtons[pos - 2]);
                sender.setVisibility(View.VISIBLE);
            ...
            callToast("Please enter a keyword");
            decrypt.setText("");
            keyView.setText("");
        }
    }
    ...
    private String getKey(int idx) {
        ...
        if (Ekey.getText().toString().trim().equals("")) {
    ...
    public void clear(View view) {
        ...
        Emessage.setText("");
        TextView Ekey = (TextView) findViewById(keys[pos]);
        Ekey.setText("");
        TextView result = (TextView) findViewById(idsResult[pos]);
        result.setText("");
        if (pos > 1) {
...
//            fileName.setLayoutParams(params);
    ...
    public void sendMessage(View view) {
        ...
        TextView key = (TextView) findViewById(keys[pos]);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == FILE_CHOOSER_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                //Uri uri = Uri.parse("storage/extCard/Download/test.txt");
