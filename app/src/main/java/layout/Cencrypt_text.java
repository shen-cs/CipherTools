 ...
 */
public class Cencrypt_text extends Fragment {


    public Cencrypt_text() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_cencrypt_text, container, false);
        EditText keyText = (EditText) rootView.findViewById(R.id.key_edit_encrypt);
        if(!getActivity().getClass().equals(MainActivity.class)) {
            keyText.setHint(getString(R.string.vhintkey));
        }
        else {
            EditText text = (EditText) rootView.findViewById(R.id.text_edit_encrypt);
            LinearLayout layout = (LinearLayout) rootView.findViewById(R.id.cencrypt_text_fragment);
            Spinner spinner = new Spinner(getActivity());
            spinner.setId(R.id.ckey_spinner_encrypt_text);
